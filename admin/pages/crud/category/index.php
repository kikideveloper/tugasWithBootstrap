<section class="content-header">
	...
	<ol class="breadcrumb">
		<li><a href="?page=crud/category/create"><i class="fa fa-plus"></i> Add New</a></li>
	</ol>
</section>
								...
								<table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
									...
									<tbody>
										...
										<tr role="row" class="odd">
											...
											<td class="sorting_1">
												<a href="?page=crud/category/update&id=<?=$itm['id_category']?>">
													<i class="fa fa-edit"></i><span> Edit</span>
												</a>
											</td>
											<td class="sorting_1">
												<a href="pages/crud/category/machine.php?action=delete&id=<?=$itm['id_category']?>">
